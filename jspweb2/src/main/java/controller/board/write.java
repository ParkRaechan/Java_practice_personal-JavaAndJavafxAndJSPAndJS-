...
public class write extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 저장 경로 [    \ : 제어문자  ->  경로 사용시 \\ , / ]
			// 1. 개발중인 프로젝트 경로
		// String uploadpath = "C:/Users/505-t/git/ezen_web_2022_A/jspweb2/src/main/webapp/board/upload";
			// 2. 서버 폴더 경로 
		...
		// 결과 
		if( result ) { response.sendRedirect("/jspweb2/board/boardlist.jsp"); }
		else { response.sendRedirect("/jspweb2/board/boardwrite.jsp"); }
