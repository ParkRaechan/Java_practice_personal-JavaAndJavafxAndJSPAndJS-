...
<title>ezen 쇼핑몰</title>
	...
	<!-- 사용자정의 css -->
	<link href="/jspweb2/css/main.css" rel="stylesheet">
	<!-- 폰트어썸[ 아이콘 ]  -->
...
<body>
	...
	<div class="container"> <!-- container : 박스권 -->
		...
		<div class="py-4"> <!-- py : 위아래 패딩(안쪽여백) -->
			<div class="row"> <!-- row : 가로배치 -->
				<div class="col-md-4"> <!-- 그리드[12조각중 4 ] -->
					<a href="/jspweb2/main.jsp" class="header_logo">EZEN SHOP</a>
				</div>
				<div class="col-md-4 offset-4 d-flex justify-content-end header_topmenu"> <!-- offset 공백그리드 -->
					...
					<% if( loginid == null ){ %> <!--  로그인이 안된 상태 = 만약에 세션이 없으면  -->
						<li> <a href="/jspweb2/member/login.jsp" class="header_topmenu">로그인</a> · </li>
		...
		<div class="navbar navbar-expand-md navbar-light bg-white">  <!--  본메뉴  -->
			<ul class="navbar-nav col-md-12 justify-content-between"> 
				...
				<li class="nav-item"> <a href="/jspweb2/board/안산시약국.jsp""> 안산시약국 </a> </li>
				<li class="nav-item"> <a href="/jspweb2/board/chatting.jsp"> 채팅(소켓) </a> </li>
				<li class="nav-item"> <a href="/jspweb2/teamchatting.jsp"> 채팅(DB) </a> </li>
	...
	<!-- 사용자정의 js -->
	<script src="/jspweb2/js/main.js" type="text/javascript"></script>
	<!-- jquery 최신 cdn -->
