...
<title>Insert title here</title>
	...
	<!-- 사용자정의 css --> <link href="/jspweb2/css/main.css" rel="stylesheet"> 	
	<!-- 사용자정의 css --> <link href="/jspweb2/css/admin.css" rel="stylesheet"> 	
...
<body>
	...
	<div  id="sidebar">
		<ul> <!--사이드바 목록  -->
			...
			<li> <a href="/jspweb2/main.jsp">홈페이지로 이동</a></li>
			<li> <a href="/jspweb2/logout">로그아웃</a></li>
		</ul>
		<!-- 사이드바 열기/닫기 사용  -->
...
<!------------- 페이지 전환시 페이지가 포함되는 구역------------->
	...
	<!-- 사용자정의 js --><script src="/jspweb2/js/dashboard.js" type="text/javascript"></script>
	<!-- 사용자정의 js --><script src="/jspweb2/js/main.js" type="text/javascript"></script>
