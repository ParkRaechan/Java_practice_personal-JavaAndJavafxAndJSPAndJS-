...
<body>
	...
	// * 공공데이터포털 [ web json페이지를 -> java 변환 ]
		...
		URL url = new URL( "https://api.odcloud.kr/api/3035882/v1/uddi:5fae3cf5-bc15-4eba-87d8-8289b74e659b_201912202015?page=1&perPage=300&serviceKey=gEFLUNqIVhv8PL3bMLYHD%2BnIBwDWXleRKJESfxcBISpvj71fCZY8dxWMQcXlyHQi65vdMVk7sXGK4cCPQJgrEg%3D%3D" );
	...
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=87c9f7d19a28db862fae301752ce5816&libraries=services,clusterer,drawing"></script>
	
	<!-- kakao 지도 api -->
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=87c9f7d19a28db862fae301752ce5816"></script>
	
	<script type="text/javascript" src="/jspweb2/js/kakaomap.js"></script>
