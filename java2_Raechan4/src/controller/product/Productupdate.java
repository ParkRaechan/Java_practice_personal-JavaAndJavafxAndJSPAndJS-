...
public class Productupdate implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		if( product.getPcategory().equals("게임기") ) { opt1.setSelected(true);}
		if( product.getPcategory().equals("슈팅게임팩") ) { opt2.setSelected(true);}
		if( product.getPcategory().equals("스포츠게임팩") ) { opt3.setSelected(true);}
		if( product.getPcategory().equals("액션게임팩") ) { opt4.setSelected(true);}
	}
    ...
    void update(ActionEvent event) {
    	...
    	if( opt1.isSelected() ) pcategory="게임기";
